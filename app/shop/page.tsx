  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        {/* Filters & Search */}
        <section className="py-8 bg-white border-b border-springz-green/10">
            ...
            <div className="space-y-6">
              ...
              {(filterParam || searchTerm || selectedCategory !== "all" || priceRange !== "all") && (
                <div className="flex flex-wrap gap-2 items-center">
                  ...
                  {filterParam && (
                    <span className="bg-springz-green/10 text-springz-green px-3 py-1 rounded-full text-sm">
                      {filterParam.replace('-', ' ')}
                    </span>
                  )}
                  {searchTerm && (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                {(searchTerm || selectedCategory !== "all" || priceRange !== "all" || filterParam) && (
                  <Button onClick={clearFilters} className="bg-springz-green hover:bg-springz-green/90">
                    Clear All Filters
                  </Button>
                )}
              </div>
